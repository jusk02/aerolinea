...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { identification: @pilot.identification, lastname: @pilot.lastname, name: @pilot.name }
    end
  ...
  test "should update pilot" do
    patch :update, id: @pilot, pilot: { identification: @pilot.identification, lastname: @pilot.lastname, name: @pilot.name }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
